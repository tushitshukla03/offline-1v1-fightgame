...
decreaseTimer()
function animate(){
  console.log(player.position.x,player.position.y,player.attackBox.position.x,player.attackBox.position.y)
  console.log(enemy.position.x,enemy.position.y,enemy.attackBox.position.x,enemy.attackBox.position.y)
